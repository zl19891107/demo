...
import List from './android_views/read/list';
import Myapp from './android_views/myapp';
    ...
    return (
       <View style={styles.container}> 
         ...
         <TabNavigator Style={styles.tab} >
           <TabNavigatorItem 
           selected={this.state.selectedTab ==='myapp'}  
           title="我的app"
          titleStyle={styles.tabText}  
          selectedTitleStyle={styles.selectedTabText} 
          renderIcon={() => <Image source={ {uri: img1_base64, scale:3.5}}/>} 
          // renderIcon={{uri: img1_base64, scale:3.5}}    
            onPress={() => {this.setState({selectedTab: 'myapp'})}}>
        {this._renderView('myapp')}
       </TabNavigatorItem>
       <TabNavigatorItem 
           ...
           titleStyle={styles.tabText}  
          selectedTitleStyle={styles.selectedTabText} 
            renderIcon={() => <Image source={ {uri: img2_base64, scale:3.5} }/>} 
           //renderIcon={{uri: img1_base64, scale:3.5}}    
       ...
       <TabNavigatorItem 
           ...
           titleStyle={styles.tabText}  
          selectedTitleStyle={styles.selectedTabText} 
            renderIcon={() => <Image source={{uri: img3_base64, scale:3.5} }/>} 
           //renderIcon={{uri: img1_base64, scale:3.5}}    
            onPress={() => {this.setState({selectedTab: 'setting'})}}>
            
           <Navigator
              initialRoute={{name: 'Setting',component:Setting}}
       ...
       <TabNavigatorItem 
           ...
           titleStyle={styles.tabText}  
          selectedTitleStyle={styles.selectedTabText} 
            renderIcon={() => <Image source={ {uri: img4_base64, scale:3.5}}/>} 
           //renderIcon={{uri: img1_base64, scale:3.5}}    
...
AppRegistry.registerComponent('mygame', () => mygame);
